...
REPOSITORIES = [
    ...
    {'url': 'git@github.com:CardinalWave/cw_message_db.git', 'branch': 'server'},
    {'url': 'git@github.com:CardinalWave/cw_central_db.git', 'branch': 'server'},
    {'url': 'git@github.com:CardinalWave/cw-bff-service.git', 'branch': 'main'},
    {'url': 'git@github.com:CardinalWave/cw-log-trace.git', 'branch': 'server'},
    {'url': 'git@github.com:CardinalWave/cw-message-service.git', 'branch': 'server'},
    {'url': 'git@github.com:CardinalWave/cw-central-service.git', 'branch': 'master'},
    {'url': 'git@github.com:CardinalWave/cw-mqtt-gateway.git', 'branch': 'server'},
    {'url': 'git@github.com:CardinalWave/cw-auth-service.git', 'branch': 'master'},
    {'url': 'git@github.com:CardinalWave/python-image-base.git', 'branch': 'main'},
 ]
